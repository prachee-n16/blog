...
> 		- Basic explanation: In [[Fundamentals of C|C]]/C++, where pointers are assigned to memory addresses, shifting memory around is dangerous since we need to update all these pointers. 
