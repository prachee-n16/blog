...
**Properties**
1. An operator is always *diagonal* on its own basis. Diagonal matrix has non-zero values in the diagonal, and zero for the rest. 
	- The diagonal elements are the eigenvalues of the operator.
2. Eigenvectors are unit vectors on their own basis. 
